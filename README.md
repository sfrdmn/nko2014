...
~~~sh
# getting the code
git clone git@github.com:nko4/cool-ladies-gif.git && cd ./cool-ladies-gif/

# developing
npm install
npm start

# deploying (to http://cool-ladies-gif.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@cool-ladies-gif.2013.nodeknockout.com
ssh root@cool-ladies-gif.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@cool-ladies-gif.2013.nodeknockout.com
ssh -i ./id_deploy root@cool-ladies-gif.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/cool-ladies-gif" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
